...
//2시 35분
	public static void main(String[] args) {
		// 사용자의 입력값을 가정
		String[] src = {"5", "2", "8", "10"}; // 숫자, 영어, 한글 등으로
		...
		try {
			...
			System.out.println("입력값에 오류가 있습니다");	// 보는 고객을 위한거
			//System.out.println("에러원인: " + e.getMessage());
			e.printStackTrace();	//개발자를 위한 것(개발자가 보려는 용도로 출력하는 시스템 에러 메시지
		} 
